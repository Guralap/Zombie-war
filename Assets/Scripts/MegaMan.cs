...
public class MegaMan : MonoBehaviour
{
    ...
    AudioSource mAlapSound;
    AudioSource malap2Sound;
    ...
    void Start ()
    {
        ...
        mAlapSound = audioSources[0];
        malap2Sound = audioSources [1];
    ...
    public void Die()
    {
        ...
        GameObject deathparticleObject = Instantiate(mDeathParticleEmitter, transform.position, transform.rotation);
        Destroy(gameObject);
    }
